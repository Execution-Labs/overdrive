...
export default defineConfig({
  ...
  webServer: [
    {
      command: `mkdir -p ${backendProjectDir} && PYTHONPATH=../src python -c "from overdrive.cli import main; import sys; raise SystemExit(main(sys.argv[1:]))" --project-dir ${backendProjectDir} server --host 127.0.0.1 --port ${backendPort}`,
