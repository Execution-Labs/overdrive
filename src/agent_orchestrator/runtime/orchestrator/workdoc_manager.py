...
"""
    ...
    def workdoc_template_for_task(self, task: Task) -> str:
        ...
        template_by_pipeline: dict[str, str] = {
            ...
            "pr_review_comment": self._COMMIT_REVIEW_WORKDOC_TEMPLATE,
            "pr_review_summarize": self._COMMIT_REVIEW_WORKDOC_TEMPLATE,
            "pr_review_fix_only": self._COMMIT_REVIEW_WORKDOC_TEMPLATE,
            "pr_review_fix_respond": self._COMMIT_REVIEW_WORKDOC_TEMPLATE,
